...
const baseDeTutoriales = {
    ...
    anses: {
        ...
        icono:     "🏛️",
        detalle:   "Desde tu celular podés pedir un turno. Seguí estos pasos.",
        pasos: [
    ...
    evitar_estafas: {
        ...
        pasos: [
            "<strong>Desconfiá de ofertas desesperadas o premios falsos:</strong> Si te llega un mensaje diciendo que ganaste un sorteo en el que no participaste, o que te van a dar un bono urgente, desconfiá. Jamás te van a apurar por canales oficiales.",
            "<strong>Mirar bien los enlaces (links), o (url):</strong> Antes de tocar, revisá bien las letras de la dirección web. Los estafadores usan nombres parecidos pero con errores (por ejemplo, 'banc0nacion' en vez de 'bancoficial'). Si no es el sitio oficial, salí de ahí.",
...
// CATEGORÍA: usos_tecnologia
    ...
    organizacion_pantallas: {
        ...
        pasos: [
            "<strong>Módulo 1: Conociendo el terreno</strong><br>Antes de ordenar, conozcamos los conceptos básicos:<br>• <strong>Pantalla de Inicio:</strong> El frente de tu casa.<br>• <strong>Pantalla Secundaria:</strong> Las habitaciones.<br>• <strong>Cuadrícula:</strong> El diseño de tus baldosas.<br>• <strong>Widgets:</strong> Ventanitas vivas con info al instante.<br>• <strong>Ergonomía de pulgar:</strong> Mantener lo importante al alcance del dedo.<br>• <strong>Jerarquía Visual:</strong> Destacar lo esencial.",
            "<strong>Módulo 2: Las Reglas de Oro del Orden</strong><br>Usamos leyes de diseño para que sea fácil:<br>• <strong>Regla de los 3 toques:</strong> Lo que usás a diario debe estar muy a mano.<br>• <strong>Ley de Hick:</strong> Menos opciones en pantalla = menos confusión.<br>• <strong>Carga cognitiva:</strong> Agrupar por tareas cansa menos a la mente.<br>• <strong>Minimalismo:</strong> Si no la usás en 2 meses, ¡fuera de la pantalla principal!",
            "<strong>Módulo 3: El Modelo Ideal</strong><br>Copiá esta distribución para mejorar tu productividad:<br><br>👉 <strong>Principal:</strong> Teléfono, WhatsApp, Cámara y Navegador.<br>👉 <strong>Secundaria:</strong> Carpetas por tareas (Bancos, Compras, Entretenimiento).<br>👉 <strong>Terciaria:</strong> Aplicaciones de uso poco frecuente.",
            "<strong>Módulo 4: Trucos según tu marca</strong><br>• 🔵 <strong>Samsung (One UI):</strong> Ajustes > Cuadrícula de pantalla.<br>• 🔵 <strong>Motorola (MyUX):</strong> Personalizar > Diseño de cuadrícula.<br>• 🔵 <strong>Google Pixel:</strong> Usá el widget 'De un vistazo' y Material You.<br>• 🍏 <strong>iPhone (iOS):</strong> Biblioteca de Apps y carpetas inteligentes.",
