...
Implementado: navegación completa, SVG locales, CTA principales, style.css compartido, scripts compartidos, fix de cierre de tooltip y visores (stopImmediatePropagation), escalado tipográfico aplicado a contenido dinámico (nav-tutorial, acciones-tutorial, paso-tutorial).

Pendiente: revisión futura de ui.js y tutoriales.js para auditoría completa de unidades font-size hardcodeadas restantes.